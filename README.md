...
- [Pixel8Bit](#pixel8bit-node) - Retro pixelation with period-accurate palettes and dithering
- [Corruptor](#corruptor-node) - Controlled corruption via wavelet transformations
- [DataBend](#databend-node) - Slice manipulation, color shifting, and distortion patterns
- [DitherMe](#ditherme-node) - Comprehensive dithering with 30+ algorithms
- [OrderedDithering](#ordereddithering-node) - Precise ordered dithering with animation support
- [GlitchIT](#glitchit-node) - JPEG corruption artifacts at the byte level
- [Interference](#interference-node) - Shader-like interference via iterative sorting
- [LineScreen](#linescreen-node) - Halftone-like line pattern effects
- [LuminousFlow](#luminousflow-node) - Flowing luminous strands of light
- [PixelFloat](#pixelfloat-node) - Gravity-affected motion via optical flow
- [PixelRedistribution](#pixelredistribution-node) - Pixel redistribution by pattern and color
- [Rekked](#rekked-node) - 12 glitch/artistic effect modes
- [Scanz](#scanz-node) - Scan lines, wave distortions, and CRT artifacts
- [TvGlitch](#tvglitch-node) - Analog TV signal distortions (YIQ color space)
- [VaporWave](#vaporwave-node) - Vaporwave aesthetics with color bands
- [VHSonAcid](#vhsonacid-node) - VHS artifacts with psychedelic color distortion
- [VideoModulation](#videomodulation-node) - CRT monitor simulation with dot patterns
...
<details>
<summary><strong>Available Palettes</strong></summary>
...
<details>
<summary><strong>Quantization & Dithering Details</strong></summary>
...
| Parameter | Description |
|-----------|-------------|
| algorithm | Dithering algorithm to use. See algorithms below. Default: floyd_steinberg |
...
<details>
<summary><strong>Dithering Types & Matrices</strong></summary>
...
<tr>
<td>
<img src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExN3k3eGQ4d3N0cXRkYndnbzg1MzFkcTlzMTh2OHllenlocnhxY2t0bCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/ei83Y3lU7fTntgHvoX/giphy.gif" width="400">
</td>
</tr>
</table>
...
| Parameter | Description |
|-----------|-------------|
| mode | Effect mode to apply (see available modes below) |
...
| Parameter | Description |
|-----------|-------------|
| color1 (Cyan) | R: 0.0, G: 0.722, B: 1.0 |
| color2 (Magenta) | R: 1.0, G: 0.0, B: 0.757 |
| color3 (Purple) | R: 0.588, G: 0.0, B: 1.0 |
| color4 (Aqua) | R: 0.0, G: 1.0, B: 0.976 |
